...
class SimpleLightFieldModelTest(unittest.TestCase):
    ...
    def test_given_valid_parameters__when_instantiating_the_model__then_model_is_created(
        self,
    ):
    ...
    def test_givan_a_valid_observation__when_forwarding_through_the_model__then_outputs_rgb_can_be_displayed(
        self,
    ):
        model = SimpleLightFieldModel(latent_dim=256, depth=False, alpha=False)
    ...
    def test_given_a_model_that_predicts_the_depth__when_forwarding_through_the_model__then_output_is_correct(
        self,
    ):
    ...
    def test_given_a_model_that_predicts_the_alpha__when_forwarding_through_the_model__then_output_is_correct(
        self,
    ):
